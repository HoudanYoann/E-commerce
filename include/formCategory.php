                    ...
                    <form method="post" action="category.php">
                        <div class="wrapper">
                            <form class="form-signin">
                                <h2 class="form-signin-heading">Ajouter une nouvelle Catégorie :</h2>
                                <input type="text" class="form-control" name="title" placeholder="Titre" required=""/>
                                <button class="btn btn-lg btn-primary btn-block" type="submit" name="categorysend">Envoyez</button>
                            </form>
                        </div>
                </div>
            </div>
